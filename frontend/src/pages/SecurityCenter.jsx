            ...
            {loadingEvents ? (
              ...
              <div className="space-y-3 max-h-[520px] overflow-auto pr-1">
                {recentAnomalies.map((event) => (
                  <article key={event._id} className="rounded-2xl border border-[#d2def4] bg-white p-4">
          ...
          <article className="surface-card p-6">
            ...
            {loadingEvents ? (
              ...
              <div className="space-y-2 max-h-[520px] overflow-auto pr-1">
                {events.map((event) => (
                  <div key={event._id} className="rounded-xl border border-[#d6e1f3] bg-white px-3 py-3">
